import { transportDatasetExample } from './transport.dataset';
import { cargoDatasetExample } from './cargo.dataset';

/**
 * Dataset completo para el problema dual integrado
 * Combina transporte y optimización de carga
 */
export const integratedDatasetExample = {
  transportProblem: transportDatasetExample,
  routeCargoConfigs: [
    {
...
/**
 * Dataset integrado simple para pruebas rápidas
 */
export const integratedDatasetSmall = {
  transportProblem: {
    origins: [
